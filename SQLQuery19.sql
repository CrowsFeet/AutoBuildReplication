...
SET @schema_option = 0x00000000080350DF

--SELECT CONVERT(INT, @schema_option, 1) & CONVERT(INT,value,1) AS Output1, *
--FROM @options
--WHERE CONVERT(INT, @schema_option, 1) & CONVERT(INT,value,1) <> 0;

DECLARE @Value BIGINT --VARBINARY(8)
...
SELECT
	CASE WHEN ID = 1 THEN COALESCE(Value,0)
				   WHEN ID = 2 THEN COALESCE(Value,0)
				   WHEN ID = 3 THEN COALESCE(Value,0)
				   WHEN ID = 4 THEN COALESCE(Value,0)
				   WHEN ID = 5 THEN COALESCE(Value,0)
				   WHEN ID = 6 THEN COALESCE(Value,0)
				   WHEN ID = 7 THEN COALESCE(Value,0)
				   WHEN ID = 8 THEN COALESCE(Value,0)
				   WHEN ID = 9 THEN COALESCE(Value,0)
				   WHEN ID = 10 THEN COALESCE(Value,0)
				   WHEN ID = 11 THEN COALESCE(Value,0)
				   WHEN ID = 12 THEN COALESCE(Value,0)
				   WHEN ID = 13 THEN COALESCE(Value,0)
				   WHEN ID = 14 THEN COALESCE(Value,0)
				   WHEN ID = 15 THEN COALESCE(Value,0)
				   WHEN ID = 16 THEN COALESCE(Value,0)
				   WHEN ID = 17 THEN COALESCE(Value,0)
				   WHEN ID = 18 THEN COALESCE(Value,0)
				   WHEN ID = 19 THEN COALESCE(Value,0)
				   WHEN ID = 20 THEN COALESCE(Value,0)
				   WHEN ID = 21 THEN COALESCE(Value,0)
				   WHEN ID = 22 THEN COALESCE(Value,0)
				   WHEN ID = 23 THEN COALESCE(Value,0)
				   WHEN ID = 24 THEN COALESCE(Value,0)
				   WHEN ID = 25 THEN COALESCE(Value,0)
				   WHEN ID = 26 THEN COALESCE(Value,0)
				   WHEN ID = 27 THEN COALESCE(Value,0)
				   WHEN ID = 28 THEN COALESCE(Value,0)
				   WHEN ID = 29 THEN COALESCE(Value,0)
				   WHEN ID = 30 THEN COALESCE(Value,0) 
				   WHEN ID = 31 THEN COALESCE(Value,0) 
				   WHEN ID = 32 THEN COALESCE(Value,0) 
				   WHEN ID = 33 THEN COALESCE(Value,0) 
				   WHEN ID = 34 THEN COALESCE(Value,0) 
				   WHEN ID = 35 THEN COALESCE(Value,0) 
				   WHEN ID = 36 THEN COALESCE(Value,0) 
				   WHEN ID = 37 THEN COALESCE(Value,0) 
				   WHEN ID = 38 THEN COALESCE(Value,0) 
				   WHEN ID = 39 THEN COALESCE(Value,0) 
				   WHEN ID = 40 THEN COALESCE(Value,0) 
				   WHEN ID = 41 THEN COALESCE(Value,0) 
				   WHEN ID = 42 THEN COALESCE(Value,0) 
				   WHEN ID = 43 THEN COALESCE(Value,0) 
				   END AS Value
FROM @options
WHERE ID IN (2,3,4,5,6,8,9,14,16,18,19,29)

SELECT CONVERT(VARBINARY(8), Sum(Value)) AS Value
FROM @Table2
