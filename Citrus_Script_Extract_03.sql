-- Lets see if I can set this up for my local version
...
EXEC sp_addpublication @publication = N'<Add_Server_Name_Here>_Replication'
...
EXEC sp_addpublication_snapshot @publication = N'<Add_Server_Name_Here>_Replication'
                               ,@frequency_type = 1
                               ...
                               ,@job_password = NULL
                               ,@publisher_security_mode = 1;
EXEC sp_grant_publication_access @publication = N'<Add_Server_Name_Here>_Replication',@login = N'sa';
GO
EXEC sp_grant_publication_access @publication = N'<Add_Server_Name_Here>_Replication',@login = N'NT AUTHORITY\SYSTEM';
GO
--EXEC sp_grant_publication_access @publication = N'<Add_Server_Name_Here>_Replication',@login = N'ECICLOUD\Domain Admins';
--GO
EXEC sp_grant_publication_access @publication = N'<Add_Server_Name_Here>_Replication',@login = N'NT SERVICE\Winmgmt';
GO
EXEC sp_grant_publication_access @publication = N'<Add_Server_Name_Here>_Replication',@login = N'NT SERVICE\SQLWriter';
GO
EXEC sp_grant_publication_access @publication = N'<Add_Server_Name_Here>_Replication',@login = N'NT SERVICE\SQLSERVERAGENT';
GO
EXEC sp_grant_publication_access @publication = N'<Add_Server_Name_Here>_Replication',@login = N'NT Service\MSSQLSERVER';
GO
EXEC sp_grant_publication_access @publication = N'<Add_Server_Name_Here>_Replication',@login = N'distributor_admin';
GO
GO

-- Adding the transactional articles
USE [<Add_DB_Name_Here>];
EXEC sp_addarticle @publication = N'<Add_Server_Name_Here>_Replication'
                  ,@article = N'CATALOGUE'
                  ,@source_owner = N'dbo'
...
EXEC sp_articlefilter @publication = N'<Add_Server_Name_Here>_Replication'
                     ,@article = N'DETAIL'
...
EXEC sp_articleview @publication = N'<Add_Server_Name_Here>_Replication'
                   ,@article = N'DETAIL'
...
use [<Add_DB_Name_Here>]
EXEC sp_addsubscription @publication = N'<Add_Server_Name_Here>_Repl', 
						@subscriber = N'<Add_Server_Name_Here>', 
						...
						@subscriber_type = 0
EXEC sp_addpushsubscription_agent @publication = N'<Add_Server_Name_Here>_Repl', 
								  @subscriber = N'<Add_Server_Name_Here>', 
								  @subscriber_db = N'<Add_DB_Name_Here>_Repl', 
								  @job_login = N'ECISOLUTIONS\agazdowicz', 
								  @job_password = null, 
								  @subscriber_security_mode = 1, -- there is a difference between AD Account and SQL Login account. 0 = SQL Login
                                  --@subscriber_login = N'<Add SQL Login>',
...
-- Adding the transactional subscriptions
USE [<Add_DB_Name_Here>];
EXEC sp_addsubscription @publication = N'<Add_Server_Name_Here>_Replication'
                       ...
                       ,@update_mode = N'read only'
                       ,@subscriber_type = 0;
EXEC sp_addpushsubscription_agent @publication = N'<Add_Server_Name_Here>_Replication'
                                 ,@subscriber = N'<Add_Subscriber_DB_Name_Here>'
                                 ,@subscriber_db = N'<Add_DB_Name_Here>_Repl'
                                 ,@job_login = NULL
                                 ,@job_password = NULL
                                 ,@subscriber_security_mode = 0
                                 ,@subscriber_login = N'<Add_Server_Name_Here>'
                                 ,@subscriber_password = NULL
                                 ,@frequency_type = 64
                                 ,@frequency_interval = 1
                                 ,@frequency_relative_interval = 1
...
--EXEC sp_addarticle 
--    @publication = N'<Add_Server_Name_Here>_Replication', -- FROM syspublications table
...
USE [<Add_DB_Name_Here>];
EXEC sp_addpublication @publication = N'<Add_Server_Name_Here>_Replication',
    @description = N'Transactional publication of database ''<Add_DB_Name_Here>'' from Publisher ''ECIC-SQL04''.',
...
EXEC sp_addpublication_snapshot @publication = N'<Add_Server_Name_Here>_Replication',
    ...
    @job_password = NULL, @publisher_security_mode = 1;
EXEC sp_grant_publication_access @publication = N'<Add_Server_Name_Here>_Replication',
    @login = N'sa';
GO
EXEC sp_grant_publication_access @publication = N'<Add_Server_Name_Here>_Replication',
...
GO
USE [<Add_DB_Name_Here>];
EXEC sp_addarticle @publication = N'<Add_Server_Name_Here>_Replication', @article = N'CONTACT',
...
GO
USE [<Add_DB_Name_Here>];
EXEC sp_addarticle @publication = N'<Add_Server_Name_Here>_Replication', @article = N'DEALS',
...
GO
USE [<Add_DB_Name_Here>];
EXEC sp_addarticle @publication = N'<Add_Server_Name_Here>_Replication', @article = N'DETAIL',
...
-- Adding the article synchronization object
EXEC sp_articleview @publication = N'<Add_Server_Name_Here>_Replication', @article = N'DETAIL',
    @view_name = N'SYNC_DETAIL_1__134',
    @filter_clause = N'DETAIL.ENTRY_ID IN (SELECT ENTRY.ENTRY_ID FROM ENTRY WHERE ENTRY.DAYBOOK_ID IN (100,130,140))',
    @force_invalidate_snapshot = 1, @force_reinit_subscription = 1;
GO
USE [<Add_DB_Name_Here>];
EXEC sp_addarticle @publication = N'<Add_Server_Name_Here>_Replication', @article = N'ENTRY',
...
-- Adding the article synchronization object
EXEC sp_articleview @publication = N'<Add_Server_Name_Here>_Replication', @article = N'ENTRY',
    @view_name = N'SYNC_ENTRY_1__134',
    @filter_clause = N'[DAYBOOK_ID] in (100,130,140)',
    @force_invalidate_snapshot = 1, @force_reinit_subscription = 1;
GO
USE [<Add_DB_Name_Here>];
EXEC sp_addarticle @publication = N'<Add_Server_Name_Here>_Replication', @article = N'EXTRA',
...
GO
USE [<Add_DB_Name_Here>];
EXEC sp_addarticle @publication = N'<Add_Server_Name_Here>_Replication', @article = N'ITEM',
...
GO
USE [<Add_DB_Name_Here>];
EXEC sp_addarticle @publication = N'<Add_Server_Name_Here>_Replication', @article = N'LOOKUP',
...
GO
USE [<Add_DB_Name_Here>];
EXEC sp_addarticle @publication = N'<Add_Server_Name_Here>_Replication', @article = N'PRODUCT',
...
GO
USE [<Add_DB_Name_Here>];
EXEC sp_addarticle @publication = N'<Add_Server_Name_Here>_Replication', @article = N'STOCK',
...
GO
USE [<Add_DB_Name_Here>];
EXEC sp_addarticle @publication = N'<Add_Server_Name_Here>_Replication', @article = N'TRADER',
...
EXEC sp_addpushsubscription_agent @publication = N'<Add_Server_Name_Here>_Replication',
    ...
    @subscriber_login = N'<Add_Server_Name_Here>', @subscriber_password = NULL,
