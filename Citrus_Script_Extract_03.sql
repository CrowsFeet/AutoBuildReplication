...
USE master;
EXEC sp_replicationdboption @dbname = N'HZN_CITRUS'
                           ,@optname = N'publish'
                           ,@value = N'true';
GO
...
EXEC sp_addpublication @publication = N'CITRUS_Replication'
                      ,@description = N'Transactional publication of database ''HZN_CITRUS'' from Publisher ''UKCB-ANDYG''.'
...
EXEC sp_addpublication_snapshot @publication = N'CITRUS_Replication'
                               ...
                               ,@job_password = NULL
                               ,@publisher_security_mode = 1;
EXEC sp_grant_publication_access @publication = N'CITRUS_Replication',@login = N'sa';
GO
EXEC sp_grant_publication_access @publication = N'CITRUS_Replication',@login = N'NT AUTHORITY\SYSTEM';
GO
--EXEC sp_grant_publication_access @publication = N'CITRUS_Replication',@login = N'ECICLOUD\Domain Admins';
--GO
--EXEC sp_grant_publication_access @publication = N'CITRUS_Replication',@login = N'ECICLOUD\andrew.gazdowicz';
--GO
--EXEC sp_grant_publication_access @publication = N'CITRUS_Replication',@login = N'ECICLOUD\tony.adams';
--GO
--EXEC sp_grant_publication_access @publication = N'CITRUS_Replication',@login = N'ECICLOUD\andrew.dams';
--GO
--EXEC sp_grant_publication_access @publication = N'CITRUS_Replication',@login = N'ECICLOUD\eci staff admins';
--GO
EXEC sp_grant_publication_access @publication = N'CITRUS_Replication',@login = N'NT SERVICE\Winmgmt';
GO
EXEC sp_grant_publication_access @publication = N'CITRUS_Replication',@login = N'NT SERVICE\SQLWriter';
GO
EXEC sp_grant_publication_access @publication = N'CITRUS_Replication',@login = N'NT SERVICE\SQLSERVERAGENT';
GO
EXEC sp_grant_publication_access @publication = N'CITRUS_Replication',@login = N'NT Service\MSSQLSERVER';
GO
EXEC sp_grant_publication_access @publication = N'CITRUS_Replication',@login = N'distributor_admin';
GO
--EXEC sp_grant_publication_access @publication = N'CITRUS_Replication',@login = N'Horizon';
--GO
--EXEC sp_grant_publication_access @publication = N'CITRUS_Replication',@login = N'AWHouse_Horizon';
GO
...
EXEC sp_articleview @publication = N'CITRUS_Replication'
                   ,@article = N'DETAIL'
...
use [HZN_CITRUS]
EXEC sp_addsubscription @publication = N'Citrus_Repl', 
						@subscriber = N'UKCB-ANDYG', 
						@destination_db = N'HZN_CITRUS_Repl', 
						@subscription_type = N'Push', 
						@sync_type = N'automatic', 
						@article = N'all', 
						@update_mode = N'read only', 
						@subscriber_type = 0
EXEC sp_addpushsubscription_agent @publication = N'Citrus_Repl', 
								  @subscriber = N'UKCB-ANDYG', 
								  @subscriber_db = N'HZN_CITRUS_Repl', 
...
--EXEC sp_addarticle 
--    @publication = N'CITRUS_Replication', -- FROM syspublications table
