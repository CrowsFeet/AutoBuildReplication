...
--CREATE PROCEDURE dbo.usp_CreateReplication
...
-------------------------------------------------------------------------------------------------------------
--
-- Description :	SP to create replication after the updater process has completed updating the database
--
-- Author :			Andy G
--
-- Created :		26/07/2017
...
VALUES ('ECIC-SQL04','HZN_CITRUS','CITRUS_Replication')
...
EXEC sp_addsubscription @publication = N''' + @PublcationName + '''
                       ,@subscriber = N''WIN-9Q8REFSVUCT'' -- this needs to be stored in tbl_DBUpdater
